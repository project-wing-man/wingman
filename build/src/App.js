...
function App() {
    const [flights, setFlights] = (0, react_1.useState)([]);
    function getFlights() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield axios_1.default.post('http://localhost:8080/api/', {
    ...
    return (react_1.default.createElement("div", { className: 'app-container' },
        ...
        react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
            react_1.default.createElement(react_router_dom_1.Routes, null,
                ...
                react_1.default.createElement(react_router_dom_1.Route, { path: "/results", element: react_1.default.createElement(SearchResults_1.default, { flights: flights }) })))));
}
exports.default = App;
